...
echo 📝 Deploying Loki...
helm upgrade --install loki grafana/loki-stack --namespace observability --set loki.persistence.enabled=true --set loki.persistence.size=5Gi --set promtail.enabled=true --wait
